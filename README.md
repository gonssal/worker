...
Once registered with [QOR Admin](http://github.com/qor/admin), [Worker](https://github.com/gonssal/worker) will provide a `Workers` section in the navigation tree, containing pages for listing and managing the following aspects of Workers:
...
[![GoDoc](https://godoc.org/github.com/gonssal/worker?status.svg)](https://godoc.org/github.com/gonssal/worker)

## Usage

```go
import "github.com/gonssal/worker"
